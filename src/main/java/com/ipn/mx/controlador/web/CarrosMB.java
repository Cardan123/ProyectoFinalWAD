 ...
 * @author cardan_mac
 */
@ManagedBean(name = "carrosMB")
@SessionScoped
public class CarrosMB extends BaseBean implements Serializable {

    private final CarrosDAO dao = new CarrosDAO();
    private final MarcasDAO marDAO = new MarcasDAO();
    ...
    /**
     * Creates a new instance of CarrosMB
     */
    public CarrosMB() {
    }
    
    public Carros getDto() {
        return dto;
    }

    public void setDto(Carros dto) {
        this.dto = dto;
    }
    ...
    public void init(){
        ...
        listaCarros = dao.readAll();
        
        
        listaMarcas = new ArrayList<>();
        listaMarcas = marDAO.readAll();
    }
    
    public String prepareAdd(){
        dto = new Carros();
        setAccion(ACC_CREAR);
        return "/carros/carrosForm?faces-redirect=true";
    }
    ...
    public String prepareIndex(){
        init();
        return "/carros/listadoCarros?faces-redirect=true";
    }
    ...
    public void reporteCarros() {
        ...
        String jasperPath = FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/reporteCarros.jasper");
...
//            System.out.println(reporte.getPath());
    ...
    public void reporteCarrosOne() {
        String user = "udtgyvrffzmoif";
        String password = "99fad350c1ebe63778407aaa771b9ec8be2251eb7079ef9ed791dcf5f80425af";
        String url = "jdbc:postgresql://ec2-52-54-167-8.compute-1.amazonaws.com/deja1jvn8k993";
        String driverPostgreSql = "org.postgresql.Driver";

        String jasperPath = FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/reporteCarro.jasper");
        ...
        try {
            ...
            parameters.put("id", dto.getIdCarro().intValue());
